...
let
  ...
  hashes = {
    "linux-x64" = "sha256-aycCM4DQaEfBpdgk+DJ+RIO1o4iqDvehx2eFZRRG1sM=";
    "linux-arm64" = "sha256-BB/+RvRRr91Ici4Wl/pF3V2A8jWQLGOFn9qvjHsfTIk=";
    "darwin-x64" = "sha256-npAenneL3oqmbchInYqtEMlmb4L/v4teDazz1feR5fM=";
